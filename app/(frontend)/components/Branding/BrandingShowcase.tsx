...
export default function BrandingShowcase({ brandShowcase }: { brandShowcase?: BrandingPage["brandShowcase"] }) {
  ...
  const imgOne = mediaUrl(brandShowcase?.showcaseImageOne, "/images/br-2.png");
  const imgTwo = mediaUrl(brandShowcase?.showcaseImageTwo, "/images/br-1.png");
      ...
      <div className="mx-auto max-w-6xl px-5">
        <div className="flex flex-col items-center gap-6 md:flex-row md:items-start">
          <div className="shrink-0">
            <Image src={sideImage} alt="" width={190} height={190} className="rounded-xl object-cover" />
          </div>
          <div className="flex-1 text-center md:text-left">
            <h2 className="text-3xl lg:text-5xl font-semibold">
              {brandShowcase?.showcaseHeading ?? "More Than Just a Logo"}
            </h2>
        ...
        <div className="mt-4 grid gap-5 md:grid-cols-2">
          <div className="overflow-hidden rounded-xl shadow-lg">
            <Image src={imgOne} alt="" width={700} height={450} className="h-full w-full object-cover transition duration-500 hover:scale-105" />
          </div>
          <div className="overflow-hidden rounded-xl shadow-lg">
            <Image src={imgTwo} alt="" width={700} height={450} className="h-full w-full object-cover transition duration-500 hover:scale-105" />
          </div>
        </div>
      </div>
    </section>
